...
public class SubActivity1 extends AppCompatActivity/**implements AutoPermissions**/{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /**
         * 버튼 누르면 화면 전환이 아니라 사실 서버에 연결해야함
         * 서버에 연결하려면 와이파이 비밀번호도 알아야하고
         * TCP/IP 통신을 통해서 연결해야 한다.
         * **/
        /*
        bt_wifi_enter = findViewById(R.id.btn_connect);
        bt_wifi_enter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SubActivity1.this, SubActivity1_enterwifiserver.class);
                startActivity(intent);
            }
        });
        * */
